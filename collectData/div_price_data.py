...
df_straw = df_straw.rename(columns={'딸기': '가격'})
df_peach = df_peach.rename(columns={'복숭아' : '가격'})
df_onion = df_onion.rename(columns={'양파' : '가격'})
df_garlic = df_garlic.rename(columns={'깐마늘(국산)' : '가격'})
